...
@torch.no_grad()
def evaluate_crowd_w_fine_grained(
    regr_model, class_model, data_loader, device, vis_dir="./visres"
):
    """
    ...
    for samples, targets in data_loader:
        ...
        regression_scores = torch.nn.functional.softmax(regression_scores, -1)[:, :, 1][
            0
        ]
        ...
        points = (
            regression_points[regression_scores > threshold]
            .detach()
            .cpu()
            .numpy()
            .tolist()
        ...
        class_logits = (
            classification_score[regression_scores > threshold]
            .detach()
            .cpu()
            .numpy()
            .tolist()
